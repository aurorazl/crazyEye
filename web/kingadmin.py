...
class AuditLogAdmin(BaseKingAdmin):
    ...
    list_display = ('id','session','user','host_to_remote_user','log_type','content','date')
    list_filter = ('session','user','host_to_remote_user','log_type','date')
