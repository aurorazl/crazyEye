...
class PageInfo(object):
    ...
    def pager(self):
        ...
        # 首页
        first_html = "<li><a href='javascript:void(0)' page_id=1>首页</a></li>"
        ...
        if page <= 1:
            ...
            prev_html = "<li><a href='javascript:void(0)' page_id=%d>上一页</a></li>" % (page - 1, )
        ...
        for i in range(int(begin), int(end)):
            #当前页
            if page == i + 1:
                a_html = "<li class='active'><a href='javascript:void(0)' page_id=%d>%d</a></li>" % (
                    i + 1, i + 1, )
            else:
                a_html = "<li><a href='javascript:void(0)' page_id=%d>%d</a></li>" % (i + 1, i + 1, )
            page_html.append(a_html)
        #下一页
        if page + 1 > all_page_count:
            next_html = "<li class='disabled'><a href='javascript:void(0)'>下一页</a></li>"
        else:
            next_html = "<li><a href='javascript:void(0)' page_id=%d >下一页</a></li>" % (page + 1, )

        page_html.append(next_html)
        #尾页
        end_html = "<li><a href='javascript:void(0)' page_id=%d >尾页</a></li>" % (all_page_count, )
